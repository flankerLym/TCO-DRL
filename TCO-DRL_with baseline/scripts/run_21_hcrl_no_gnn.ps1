# Ablation: HCRL-Oracle without graph encoder.
Set-Location -Path (Split-Path -Parent $PSScriptRoot)
Set-Location -Path "TCO-DRL_with baseline"
python main.py `
  --Scenario rl_harder `
  --Use_RA_DDQN --Use_PB_SafeDQN --Use_COBRA --Use_HCRL `
  --Disable_GNN_Encoder `
  --Oracles_Per_Type 10 --Epoch 30 --Request_Num 6000 `
  --Reward_Scale 2.0 --Reward_Clip 2.0 `
  --Dqn_lr 0.0015 --RA_lr 0.0012 --COBRA_lr 0.0014 --HCRL_lr 0.0014 --HCRL_Mode_lr 0.0012 `
